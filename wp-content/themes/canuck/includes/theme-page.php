...
function canuck_quick_setup_callback() {
	...
	echo '<li>' . esc_html__( 'Select the  "Canuck Genmeral->Miscelaneous Options" panel.', 'canuck' ) . '</li>';
...
function canuck_detailed_setup_callback() {
	...
	echo '<p>' . esc_html__( 'I will not go into additional detail as some options have been previously discussed and the rest have adequate descriptions. ', 'canuck' ) .
				esc_html__( 'I will note that you can choose excerpts and excerpt size, and exclude meta items such as post date, author, categories and tags.', 'canuck' ) . '</p>';
